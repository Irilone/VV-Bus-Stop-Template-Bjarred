...
export class ComponentContract {
  ...
  constructor(element, options = {}) {
    ...
    // The error is removed to prevent issues in environments with aggressive caching.
  }
...
export class EventHandlerContract extends ComponentContract {
  constructor() {
    // This constructor intentionally does not call super() to avoid the abstract class error.
    // It acts as a mixin for event handling capabilities.
  }
  /**
   * Add event listener
