...
/**
 * Manages lightbox functionality for images.
 */
export class Lightbox {
  ...
  bindEvents() {
    ...
    if (typeof this.selector !== 'string') {
      console.error('Lightbox: selector must be a string, got:', typeof this.selector, this.selector);
      return;
    }
    ...
    if (this.lightboxElement) {
      ...
      if (lightboxImage) {
        eventManager.on(lightboxImage, 'error', this.handleImageError.bind(this));
      }
    }
  }
