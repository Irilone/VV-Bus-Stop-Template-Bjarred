...
class FAQToggle {
    constructor(options = {}) {
        this.options = {
            selector: '.faq-item, details[data-faq]',
            summarySelector: '.vaccine-summary, summary',
            contentSelector: '.faq-content, .vaccine-content',
            activeClass: 'active',
    ...
    fixDuplicateTitles() {
        this.faqs.forEach((faq, faqId) => {
            ...
            if (cleanText) {
                // Optimize Swedish text for 1-2 row display
